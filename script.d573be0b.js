...
$(function () {
  ...
  if ($(window).width() < 750) {
    ...
    $(".data-router-view").removeAttr("data-router-view"); // $(".navbar").find(".navbar__item").click(function(){
  ...
  var $bckground_popup = $('.wrapperPopup');
...
},{}]},{},["../../../../Users/khun/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/script.js"], null)
